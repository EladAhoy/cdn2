...
export default function CheckoutPage() {
  ...
  const handleShowSelection = (event: FixMeLater) => {
  ...
  const handleQuantityChange = (event: FixMeLater) => {
    setQuantity(event.target.value);
  };

  const handleBillingInfoChange = (event: FixMeLater) => {
      ...
      <form className="checkout-form">
        <section>
          ...
          <fieldset className="delivery-details">
            <h2>Delivery</h2>
            <p>
              Tickets will be emailed to you in addition to being available on
              the app.
            </p>
          </fieldset>
        </section>
